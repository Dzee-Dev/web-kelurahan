...
function buildWaMessage(data) {
  ...
  lines.push('📋 *PENGAJUAN SURAT KELURAHAN*');
  lines.push('━━━━━━━━━━━━━━━━━━━━━━━');
  lines.push('');
  ...
  if (data.data_pribadi) {
    ...
    if (dp.jenis_kelamin) lines.push(`Jenis Kelamin: ${dp.jenis_kelamin}`);
  ...
  lines.push('━━━━━━━━━━━━━━━━━━━━━━━');
  lines.push(`🕐 Diajukan: ${new Date().toLocaleString('id-ID', { timeZone: 'Asia/Jakarta' })}`);
